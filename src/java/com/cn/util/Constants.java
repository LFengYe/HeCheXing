...
//    public static final double factoryLongitude = 125.226824;
     ...
     */
    public static final String SMS_PLATFORM_ACCOUNT_SID = "8aaf07085f004cdb015f0545a9d90208";
    /**
     * 短信发送平台主帐号令牌（AUTH TOKEN）
     */
    public static final String SMS_PLATFORM_AUTH_TOKEN = "677460ffb07a4dfa9fa29f58dab4fa9c";
    /**
     * 短信发送平台应用ID（APP ID）
     */
    public static final String SMS_PLATFORM_APP_ID = "8aaf07085f004cdb015f0545ab43020f";
    /**
     * 注册短信模板ID
     */
     ...
     * 绑定设备短信模板ID
     */
    public static final String SMS_PLATFORM_BAND_DEVICE_TEMPLATE_ID = "209709";
    /**
     * 绑定设备短信过期分钟数
     */
    public static final String SMS_NEW_DEVICE_EXPIRED_MINUTE = "30";
}
